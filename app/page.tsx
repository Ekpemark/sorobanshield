...
export default function Home() {
  ...
  return <main><nav><a className="brand" href="#top"><span>◈</span> SorobanShield</a><div><a href="#scanner">Scanner</a><a href="#how">How it works</a><a href="/grant">Grant brief</a><button className="nav-button" onClick={() => document.getElementById("scanner")?.scrollIntoView()}>Run a scan</button></div></nav>
